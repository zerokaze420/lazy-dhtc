...
var translations = map[string]map[string]string{
	"en-US": {
		...
		"watches":                   "Watches",
		"workers":                   "Workers",
		"workers_subtitle":          "Monitor public crawler workers and pull queues",
		"workers_master_only":       "Worker management is available when this node runs in master mode.",
		"workers_total":             "Total Workers",
		"workers_online":            "Online",
		"workers_queued":            "Queued",
		"workers_dropped":           "Dropped",
		"workers_pulled":            "Pulled",
		"workers_last_success":      "Last Success",
		"workers_last_error":        "Last Error",
		"workers_empty":             "No Worker URLs are configured.",
		"workers_restart_hint":      "Worker URLs and the cluster token take effect immediately after saving.",
		"online":                    "Online",
		"offline":                   "Offline",
		"status":                    "Status",
		...
		"crawler_manual_override":   "Manual override active until",
	...
	"zh-CN": {
		...
		"watches":                   "订阅",
		"workers":                   "Worker 管理",
		"workers_subtitle":          "监控公网采集节点、队列和拉取状态",
		"workers_master_only":       "只有 Master 模式提供 Worker 管理功能。",
		"workers_total":             "Worker 总数",
		"workers_online":            "在线",
		"workers_queued":            "待拉取",
		"workers_dropped":           "已丢弃",
		"workers_pulled":            "累计拉取",
		"workers_last_success":      "最后成功",
		"workers_last_error":        "最近错误",
		"workers_empty":             "尚未配置 Worker 地址。",
		"workers_restart_hint":      "Worker 地址和集群 Token 保存后立即生效。",
		"online":                    "在线",
		"offline":                   "离线",
		"status":                    "状态",
		"appearance":                "外观",
		...
		"crawler_manual_override":   "手动操作优先，持续到",
